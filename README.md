...
2. Download the [icons for Navbar](https://github.com/PedroMachado1/Koreader.patches/blob/main/icons%20for%20NavBar.zip) file from the repository and extract the icons into `koreader/resources/icons/mdlight/`.
